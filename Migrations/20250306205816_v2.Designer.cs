            ...
            modelBuilder.Entity("loja_api.Entities.MarketCart", b =>
                {
                    ...
                    b.OwnsOne("loja_api.Entities.auxiliar.Attdata", "AttDate", b1 =>
                        {
                            b1.Property<Guid>("MarketCartId")
                                .HasColumnType("TEXT");

                            b1.PrimitiveCollection<string>("Assunto")
                                .IsRequired()
                                .HasColumnType("TEXT");

                            b1.PrimitiveCollection<string>("Data")
                                .IsRequired()
                                .HasColumnType("TEXT");

                            b1.HasKey("MarketCartId");

                            b1.ToTable("MarketCart");
